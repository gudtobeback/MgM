...
export const ModeSelectionScreen: React.FC<ModeSelectionScreenProps> = ({
  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      ...
      {/* Hero Row: Drift Detection + Network Health */}
      {connectedOrgs?.length > 0 && (
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-8 flex flex-col gap-4 p-5 bg-white rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.10)]">
            <div className="flex flex-col gap-2">
              <p className="text-md font-bold">Drift Detection</p>

              <p className="text-xs text-black/60">
                DealMyTime — Compares the current config against a pinned golden
                config snapshot.
              </p>
            </div>

            <div className="flex items-center justify-between gap-5 p-3 bg-[#FFF9E6] border border-[#FFC000] rounded-md">
              <div className="flex flex-col gap-2">
                <p className="text-sm text-[#D7A306]">
              ...
              <button className="px-6 py-2.5 text-xs text-nowrap text-white bg-[#FFC000] rounded-md">
                Set Golden Config
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-4 p-5 bg-white rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.10)]">
        <div className="text-md font-bold">Compilance Monitoring</div>
      </div>
        ...
        <div className="grid grid-cols-20 gap-5">
          {TOOLS.map((tool, index) => (
            <button
              ...
              className={`col-span-20 sm:col-span-10 lg:col-span-4 flex items-start gap-3 p-4 text-left rounded-lg border border-[#EFEFEF] transition-all`}
            >
              <div
