  ...
  return (
    <div className="bg-[url('/images/cloud.jpg')] bg-cover rounded-3xl overflow-hidden">
      <div className="flex flex-col items-center justify-center gap-10 p-5 lg:h-[650px] lg:p-0">
        ...
        {/* Grid */}
        <div className="grid grid-cols-18 gap-3 md:gap-5 lg:w-[820px]">
          <div
            ref={ref2}
            className={`col-span-9 lg:col-span-5 lg:h-[210px] flex flex-col items-start justify-center p-10 text-white bg-black rounded-2xl
          ...
          <div
            ref={ref2}
            className={`col-span-9 lg:col-span-5 lg:h-[210px] flex flex-col items-start justify-center p-10 text-black bg-white rounded-2xl
          ...
          <div
            ref={ref1}
            className={`col-span-18 lg:col-span-8 lg:h-[210px] flex flex-col items-start justify-between gap-4 lg:gap-0 p-8 text-black bg-[#D7FB71] rounded-2xl
          ...
          <div
            ref={ref1}
            className={`col-span-18 lg:col-span-8 lg:h-[210px] flex flex-col items-start justify-between gap-4 lg:gap-0 p-8 text-black bg-white rounded-2xl
            ${show1 ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-20"} transition-all duration-1000 ease-out`}
          >
            <p className="font-medium text-sm">
          ...
          <div
            ref={ref2}
            className={`col-span-9 lg:col-span-5 lg:h-[210px] flex flex-col items-start justify-center p-10 text-white bg-[#015A94] rounded-2xl
            ${show2 ? "opacity-100 translate-x-0" : "opacity-0 translate-y-20"} transition-all duration-1000 ease-out`}
          >
            <p className="font-medium text-[28px] sm:text-[36px] md:text-[48px] leading-tight md:leading-14">
