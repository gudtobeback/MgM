...
export function CompanyDetailPage() {
  ...
  const companyId = parseInt(companyIdParam || "0", 10);
  ...
  if (!company) {
    return (
      <div style={{ padding: "32px", fontSize: "14px", color: "#dc2626" }}>
        Company not found.
      </div>
    );
  }
  ...
  return (
    <div>
      <button
        onClick={() => navigate(TOOL_MODE_ROUTES["admin-companies"])}
        style={{
          display: "flex",
          alignItems: "center",
          gap: "6px",
      ...
      {showAddUser && (
        ...
        >
            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewUser((p) => ({ ...p, [field.key]: e.target.value }))
                  }
          ...
          {addError && (
            <div
              style={{ fontSize: "12px", color: "#dc2626", marginTop: "8px" }}
            >
              {addError}
            </div>
          )}
