    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-[#f0f4f8] relative overflow-hidden font-sans text-slate-800">
      ...
      <div className="relative z-10 w-full max-w-[420px] animate-fade-in-up">
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 mb-2">Meraki<span className="text-blue-600">Migrate</span></h1>
        ...
        <div className="glass-card bg-white/70 backdrop-blur-2xl border border-white/60 shadow-xl shadow-slate-200/50 p-8 rounded-[2rem]">
          ...
          <div className="flex items-center justify-center gap-1 mb-8 p-1.5 bg-slate-100/50 rounded-xl border border-white/50 relative">
            <button
              ...
              className={cn(
                "flex-1 py-2.5 text-sm font-semibold rounded-lg transition-all duration-300 relative z-10",
                isLogin ? "bg-white text-slate-900 shadow-sm ring-1 ring-black/5" : "text-slate-500 hover:text-slate-700"
              )}
            >
              Sign In
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                {isLogin && <a href="#" className="text-xs font-semibold text-blue-600 hover:text-blue-700 hover:underline">Forgot?</a>}
              </div>
              <Input
                type="password"
                placeholder="••••••••"
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-blue-500/25 transition-all hover:scale-[1.02] hover:shadow-blue-500/40 mt-2"
              disabled={loading}
            >
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-medium">
              ...
              <span className="font-bold text-slate-600">Antigravity Core v2.0</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 mx-auto max-w-[340px] animate-fade-in delay-200">
          <div className="bg-white/40 backdrop-blur-md border border-white/50 rounded-2xl p-4 text-center">
            ...
            <div className="flex justify-center gap-3">
              <button
                onClick={() => { setEmail('admin@demo.com'); setPassword('Admin1234!'); setIsLogin(true); }}
              ...
              <button
                onClick={() => { setEmail('free@demo.com'); setPassword('Demo1234!'); setIsLogin(true); }}
                className="px-4 py-2 bg-white rounded-lg text-xs font-semibold text-slate-600 shadow-sm border border-slate-100 hover:text-blue-600 hover:border-blue-200 transition-colors"
              >
                Free User
              </button>
